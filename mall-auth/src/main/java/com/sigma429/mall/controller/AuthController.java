...
public class AuthController {
    ...
    public CommonResult<Oauth2TokenDTO> postAccessToken(HttpServletRequest request,
                                                        ...
                                                        @ApiParam("刷新token") @RequestParam(required = false) String refresh_token, @ApiParam("登录用户名") @RequestParam(required = false) String username, @ApiParam("登录密码") @RequestParam(required = false) String password) throws HttpRequestMethodNotSupportedException {
