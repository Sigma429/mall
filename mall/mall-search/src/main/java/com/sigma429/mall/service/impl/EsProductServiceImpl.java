...
import com.sigma429.mall.repository.EsProductRepository;
...
public class EsProductServiceImpl implements EsProductService {
    ...
    public Page<EsProduct> search(String keyword, Long brandId, Long productCategoryId, Integer pageNum,
        ...
        if (StringUtils.isEmpty(keyword)) {
            ...
            filterFunctionBuilders.add(new FunctionScoreQueryBuilder.FilterFunctionBuilder(QueryBuilders.matchQuery(
                    "name", keyword),
    ...
    public EsProductRelatedInfo searchRelatedInfo(String keyword) {
        ...
        AbstractAggregationBuilder aggregationBuilder = AggregationBuilders.nested("allAttrValues", "attrValueList")
                .subAggregation(AggregationBuilders.filter("productAttrs", QueryBuilders.termQuery("attrValueList" +
                                ".type", 1))
    ...
    private EsProductRelatedInfo convertProductRelatedInfo(SearchHits<EsProduct> response) {
        ...
        List<? extends Terms.Bucket> attrIds =
                ((ParsedLongTerms) ((ParsedFilter) ((ParsedNested) productAttrs).getAggregations().get("productAttrs")).getAggregations().get("attrIds")).getBuckets();
